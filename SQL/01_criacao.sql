...
GO CREATE INDEX IX_Carteira_CodigoCorretora ON wallet.Carteira (CodigoCorretora);

GO CREATE INDEX IX_ItemCarteira_IdCarteira ON wallet.ItemCarteira (IdCarteira);

GO CREATE INDEX IX_ItemCarteira_CodigoMoeda ON wallet.ItemCarteira (CodigoMoeda);

GO CREATE INDEX IX_ParesMoedas_Base ON wallet.ParesMoedas (CodigoMoedaBase);

GO CREATE INDEX IX_ParesMoedas_Cotacao ON wallet.ParesMoedas (CodigoMoedaCotacao);
